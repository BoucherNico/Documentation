...
## Consultation
Voici un exemple au format JSON de la consultation d'une Taxe (certains champs techniques n'apparaissent pas) :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg5NTczMTIwNSwtNDc0MzU5MDUyLDE2MT
